...
AF = f"mikeroySoft/agent-factory@{AF_SHA}/agent_factory/"
...
STATIC_BLOCKS = r"""  // GitHub (back row)
  ...
  { id:'upstream', name:'Fork parents', cat:'ext', gx:20.5, gy:0.3, w:2.2, d:2, h:8, kind:'pad',
    ...
    files:[ ['mikeroySoft/agent-factory@8f9baad/agent_factory/dispatch.py',469,'sync_pass(): one merge per pass, conflicts open a ready-for-human issue'], ['mikeroySoft/agent-factory@8f9baad/agent_factory/config.py',49,'[repo].upstream is repo-owned'] ],
